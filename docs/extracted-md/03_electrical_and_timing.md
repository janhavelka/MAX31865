...
| Continuous power dissipation, TQFN, TA = +70degC | 2758.6 mW, derate 34.5 mW/degC above +70degC | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| Continuous power dissipation, SSOP, TA = +70degC | 952.4 mW, derate 11.9 mW/degC above +70degC | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| ESD protection, all pins, Human Body Model | +/-2 kV | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| Operating temperature range | -40degC to +125degC | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| Junction temperature | +150degC | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| Storage temperature range | -65degC to +150degC | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| Soldering temperature, reflow | +260degC | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| Lead temperature, soldering, 10 s | +300degC | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
...
|---|---|---:|---|
| TQFN | Junction-to-ambient thermal resistance, thetaJA | 29degC/W | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| TQFN | Junction-to-case thermal resistance, thetaJC | 2degC/W | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| SSOP | Junction-to-ambient thermal resistance, thetaJA | 84degC/W | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| SSOP | Junction-to-case thermal resistance, thetaJC | 32degC/W | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |

## Recommended DC Operating Conditions

Conditions for this table are `TA = -40degC to +125degC, unless otherwise noted`; the table references Notes 2 and 3. [Source: MAX31865 RTD-to-Digital Converter, p. 2]
...
| Reference resistor | RREF | - | 350 | - | 10k | Ohm | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |
| Cable resistance | RCABLE | Per lead | 0 | - | 50 | Ohm | [Source: MAX31865 RTD-to-Digital Converter, p. 2] |

## DC Electrical Characteristics

Conditions for the electrical characteristics table are `3.0 V <= VDD <= 3.6 V`, `TA = -40degC to +125degC`, unless otherwise noted. Typical values are at `TA = +25degC`, `VDD = VDVDD = 3.3 V`. The table references Notes 2 and 3. [Sources: MAX31865 RTD-to-Digital Converter, p. 2; MAX31865 RTD-to-Digital Converter, p. 3]
...
| Input leakage current | - | RTDIN+, RTDIN-, 0degC to +70degC, on-state | - | - | 2 | - | nA | [Source: MAX31865 RTD-to-Digital Converter, p. 3] |
| Input leakage current | - | RTDIN+, RTDIN-, -40degC to +85degC, on-state | - | - | 5 | - | nA | [Source: MAX31865 RTD-to-Digital Converter, p. 3] |
| Input leakage current | - | RTDIN+, RTDIN-, -40degC to 100degC, on-state | - | - | 14 | - | nA | [Source: MAX31865 RTD-to-Digital Converter, p. 3] |
...
| Noise over Nyquist bandwidth | - | Input referred | - | 150 | - | - | uV RMS | [Source: MAX31865 RTD-to-Digital Converter, p. 3] |
...
| Automatic fault detection cycle time | - | From CS high to cycle complete | - | 550 | 600 | - | us | [Source: MAX31865 RTD-to-Digital Converter, p. 3] |
...
| Input leakage current | IL | Logic inputs | -1 | - | +1 | - | uA | [Source: MAX31865 RTD-to-Digital Converter, p. 3] |
...
Conditions for the AC SPI table are `3.0 V <= VDD <= 3.6 V`, `TA = -40degC to +125degC`, unless otherwise noted. Typical values are at `TA = +25degC`, `VDD = VDVDD = 3.3 V`. The table references Notes 3 and 7 and Figures 1 and 2. [Source: MAX31865 RTD-to-Digital Converter, p. 4]
...
| 3 | Limits are 100% production tested at TA = +25degC and/or TA = +85degC. Limits over the operating temperature range and relevant supply voltage range are guaranteed by design and characterization. Typical values are not guaranteed. | [Source: MAX31865 RTD-to-Digital Converter, p. 4] |
| 4 | For 15-bit settling, a wait of at least 10.5 time constants of the input RC network is required. Max startup time is calculated with a 10 kOhm reference resistor and a 0.1 uF capacitor across the RTD inputs. | [Source: MAX31865 RTD-to-Digital Converter, p. 4] |
...
| 6 | Specified with no load on the bias pin as the sum of analog and digital currents. No active communication. If the RTD input voltage is greater than the input reference voltage, then an additional 400 uA IDD can be expected. | [Source: MAX31865 RTD-to-Digital Converter, p. 4] |
...
The typical operating characteristics page states conditions of `VDD = VDVDD = 3.3 V`, `TA = +25degC`, unless otherwise noted. [Source: MAX31865 RTD-to-Digital Converter, p. 6]

| Figure title | Axes/ranges and visible labels | Source |
|---|---|---|
| Supply current vs. temperature, ADC auto conversion mode | Y-axis is IDD in mA from 0 to 4; x-axis is temperature in degC with visible range -50 to 150. Traces are labeled `ANALOG IDD (BIAS PIN UNLOADED)` and `DIGITAL IDD`. | [Source: MAX31865 RTD-to-Digital Converter, p. 6] |
| Supply current vs. temperature, ADC normally off mode | Y-axis is IDD in mA from 0 to 4; x-axis is temperature in degC with visible range -50 to 150. Traces are labeled `ANALOG IDD (BIAS PIN UNLOADED)` and `DIGITAL IDD`. | [Source: MAX31865 RTD-to-Digital Converter, p. 6] |
| Leakage current per pin vs. temperature | Subtitle states `1 VOLT APPLIED TO FORCE+, FORCE2, RTDIN+, RTDIN- PINS`. Y-axis is current in nA from 0 to 140; x-axis is temperature in degC with visible range 50 to 150. | [Source: MAX31865 RTD-to-Digital Converter, p. 6] |
...
| ADC conversion error vs. RTD resistance, 4 kOhm RREF, 4-wire connection | Y-axis is error in Ohm from -0.488 to +0.488; x-axis is RRTD in Ohm with visible range 0 to 3500. Traces are labeled -40degC, +25degC, and +100degC; a bracket labels approximately +/-0.1degC error. | [Source: MAX31865 RTD-to-Digital Converter, p. 6] |
| ADC conversion error vs. RTD resistance, 400 Ohm RREF, 4-wire connection | Y-axis is error in Ohm from -0.488 to +0.488; x-axis is RRTD in Ohm with visible range 0 to 350. Traces are labeled -40degC, +25degC, and +100degC; a bracket labels approximately +/-0.1degC error. | [Source: MAX31865 RTD-to-Digital Converter, p. 6] |
